      ...
      <div className="relative h-full flex flex-col justify-center items-center text-center px-4">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            <span className="block">Hi, I'm Sanjana</span>
            <span className="text-green-400">Creative Developer</span>
          </h1>
          <p className="text-xl text-green-100 mb-8">I create beautiful digital experiences that make an impact</p>
          <motion.button
