          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-green-100">hello@sanjana.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-green-100">San Francisco, California</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-green-600 p-3 rounded-full text-white hover:bg-green-500 transition-colors">
